...
const Features = () => {
  return(
       <main className="w-[1440px] h-[355px] text-white">
        ...
        <div className="w-[1440px] h-[355px] text-white flex justify-around items-center" >
      ...
      <div className="w-[266px] h-[124px] top-[145px] left-[415px]  gap-[16px]">
        ...
        <div className='w-[235px] h-[124px] top-[145px] left-[739px]  gap-[16px] '>
         ...
         <div className='top-[145px]  left-[1065px] gap-[13px]'>
          <Image src={"/Feature block3.png"} alt="Features block 3" width={265} height={124}/>
        </div>
      </div>
      </main>
  );
